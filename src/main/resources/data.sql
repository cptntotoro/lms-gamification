...
VALUES
    (gen_random_uuid(), 'quiz', 'Квиз / Тест', 80, 400, true, NOW(), NOW()),
...
VALUES
    (gen_random_uuid(), 'alex123', 1250, 12, '2026-01-10 09:30:00', '2026-02-19 14:45:00'),
...
VALUES
    ...
    (gen_random_uuid(), 'alex123', 'evt-project-005', 'project', 500, 'Курсовая работа по дисциплине', '2026-02-10 15:00:00'),
